...
enum abce_opcode {
  ...
  ABCE_OPCODE_PUSH_NEW_ARRAY = 35,
  ABCE_OPCODE_PUSH_NEW_DICT = 36,
  ABCE_OPCODE_PUSH_FROM_CACHE = 37,
  ABCE_OCODE_POP = 38,
  ABCE_OCODE_POP_MANY = 39,
  ABCE_OPCODE_STRGET = 40,
  ABCE_OPCODE_STRLEN = 41,
  ABCE_OPCODE_APPEND_MAINTAIN = 42,
  ABCE_OPCODE_APPENDALL_MAINTAIN = 43,
  ...
  ABCE_OPCODE_CALL_IF_FUN = 59,
  ABCE_OPCODE_DICTLEN = 59,
  ABCE_OPCODE_UNUSED_COMMON0 = 60,
  ABCE_OPCODE_UNUSED_COMMON1 = 61,
  ABCE_OPCODE_UNUSED_COMMON2 = 62,
  ABCE_OPCODE_UNUSED_COMMON3 = 63,
